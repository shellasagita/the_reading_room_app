...
body: Stack(
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _buildFeatureCard(context, Icons.menu_book, 'Book List', AppRoutes.bookList),
              _buildFeatureCard(context, Icons.book_outlined, 'Borrow Book', AppRoutes.borrowBook),
              _buildFeatureCard(context, Icons.history, 'Borrow History', AppRoutes.bookHistory),
              _buildFeatureCard(context, Icons.add_box, 'Add Book', AppRoutes.addBook),
              _buildFeatureCard(context, Icons.delete, 'Delete Book', AppRoutes.deleteBook),
              _buildFeatureCard(context, Icons.person, 'Profile', AppRoutes.profile),
            ],
          ),
        ],
      ),
  ...
  Widget _buildFeatureCard(BuildContext context, IconData icon, String label, String route) {
  return InkWell(
